        ...
        <div className='col-md-10'>
            <div className='bg-white pb-1 pt-4 px-4 content'>
                ...
                <div className='my-2'>
                    ...
                    <div className='d-flex flex-row my-3'>
                        <div className='col-md-4'>
                            <form className="form-floating input-group">
                                <input type="text" style={{borderRightWidth:'0px'}} className="form-control" id="floatingInputValue" placeholder="Design Strategy" value="Design Strategy"/>
                                <span className="input-group-text bg-white" id="basic-addon2">
                                    <img className='bg-white border-0' onClick={handleClick} src={Addskill} alt={'Add skill'}/>
                                </span>
                    ...
                    {shown && (
                        <div>
                            <div className='skillname mb-3 mx-2'>You can only add up to five skills</div>
                            <div className='d-flex flex-row'>
                ...
                <div className='my-2'>
                    ...
                    <div className='d-flex flex-row'>
                        <div className='col-md-7'>
                            <textarea style={{resize:'none'}} className="form-control" id="exampleFormControlTextarea1" rows="5" placeholder='Type Something...'></textarea>
                        </div>                                    
                    </div>
                </div>
