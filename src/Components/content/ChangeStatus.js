        ...
        <div className='col-sm-10'>
            <div id='content' className='bg-white px-4'>
                ...
                <div className='mt-3 d-flex flex-row'>
                    <div onClick={profileClick} style={{color: isProfile ? '#0C0C0C' : '#A2A2A2',}} className='col-1'>Profile</div>
                    <div onClick={statusClick} style={{color: isStatus ? '#0C0C0C' : '#A2A2A2',}} className='col-1'>Status</div>
                    <div onClick={notesClick} style={{color: isNotes ? '#0C0C0C' : '#A2A2A2',}} className='col-1'>Notes</div>
                </div>
                {profileShow && (
                    <CandidateProfile />
                )}
